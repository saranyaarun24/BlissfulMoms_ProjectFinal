...
import com.fullerton.project.blissfulmoms.databinding.ActivityRootBinding;

import java.util.Set;
/*This is the entry point for the code where Blissful Moms' system checks for the initial connection with the FitBit Web API*/
