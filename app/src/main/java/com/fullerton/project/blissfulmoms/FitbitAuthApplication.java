...
public class FitbitAuthApplication extends Application {
    ...
    private static final String CLIENT_SECRET = "cdb1bfc267b611117e19cbfd8d60478c";
    ...
    public static AuthenticationConfiguration generateAuthenticationConfiguration(Context context, Class<? extends Activity> mainActivityClass) {
        ...
        try {
            ...
            String clientId = bundle.getString("com.fullerton.project.blissfulmoms.CLIENT_ID");
            String redirectUrl = bundle.getString("com.fullerton.project.blissfulmoms.REDIRECT_URL");
            ...
            return new AuthenticationConfigurationBuilder()
                    ...
                    .addRequiredScopes(Scope.profile, Scope.settings, Scope.heartrate, Scope.sleep)
